...
The project was created and installed in your current python environment. Then go to the ``dh_project`` package and create a new problem:
...
.. code-block:: console
    ...
    cd dh_project/dh_project/polynome2
...
.. code-block:: console
    ...
    deephyper nas random --evaluator ray --problem dh_project.polynome2.problem.Problem
...
.. code-block:: console
    ...
    balsam job --name poly_exp --workflow poly_exp --app PPO --num-nodes 2 --args "--evaluator balsam --problem dh_project.polynome2.problem.Problem"
...
.. code-block:: console
    ...
    environ_vars:
    application:                    PPO
    args:                           --evaluator balsam --problem dh_project.polynome2.problem.Problem
    user_workdir:
    ...
    data:                           {}
    *** Executed command:         /lus/theta-fs0/projects/datascience/regele/dh-opt/bin/python -m deephyper.search.nas.regevo --evaluator balsam --problem dh_project.polynome2.problem.Problem
